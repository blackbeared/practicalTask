...
extension TextX on TextStyle {
  double get defaultFontSize => fontSize ?? 13;
  ...
  /// Shortcut for medium weight
  TextStyle get medium => weight(FontWeight.w600);

  /// Shortcut for semibold weight
  TextStyle get semiBold => weight(FontWeight.w800);
  ...
  /// Shortcut for italic
  TextStyle get black => colored(Colors.black);

  TextStyle get white => colored(Colors.white);

  TextStyle get white54 => colored(Colors.white54);
  ...
  /// Shortcut for color
  TextStyle colored(Color v) => copyWith(color: v);
  ...
  TextStyle scale(double v) => copyWith(fontSize: defaultFontSize * v);
...
//
// TextStyle makeResponsive(Mode mode) => copyWith(fontSize: mode == Mode.DESKTOP || mode == Mode.TABLET_LANDSCAPE
//     ? defaultFontSize * 1.6
//     : mode == Mode.TABLET_PORTRAIT
//     ? defaultFontSize*1.1
//     : defaultFontSize);
}
